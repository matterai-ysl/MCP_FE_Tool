...
def main():
    ...
    print("\n3. 生成特征并创建报告...")
    generator.create_enhanced_dataset(output_path='test_enhanced.csv')

    print("\n" + "=" * 50)
    print("✓ 测试完成!")
    print("  增强数据已保存: test_enhanced.csv")
    print("  文本报告已保存: test_enhanced_feature_report.txt")
    print("  HTML报告已保存: test_enhanced_feature_report.html")
